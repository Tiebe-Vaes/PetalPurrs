...
const CUPS = [
  { id: 'mug',    name: 'Warm Mug',     shape: 'mug',    color: '#e8b596', ring: '#d48f6c', unlock: 1 },
  { id: 'teacup', name: 'Classic Teacup', shape: 'teacup', color: '#fff8ee', ring: '#c9a3d4', unlock: 1 },
  { id: 'tall',   name: 'Tall Glass',   shape: 'tall',   color: '#d8ecf5', ring: '#7aa3b5', unlock: 1 },
  { id: 'bowl',   name: 'Tea Bowl',     shape: 'bowl',   color: '#a8c4a2', ring: '#7fa079', unlock: 2 },
  { id: 'travel', name: 'To-Go',        shape: 'travel', color: '#c9a3d4', ring: '#a57ab0', unlock: 3 },
  { id: 'mug-butter', name: 'Butter Mug', shape: 'mug',  color: '#f3d8a8', ring: '#c99e5c', unlock: 2 },
  { id: 'rose-cup', name: 'Rose Cup',   shape: 'teacup', color: '#f8d6d6', ring: '#d97570', unlock: 4 },
  { id: 'sage-bowl', name: 'Sage Bowl', shape: 'bowl',   color: '#c4dbbe', ring: '#7fa079', unlock: 5 },
];
...
const EXTRAS = [
  ...
  { id: 'mint',     name: 'Fresh Mint', price: 2 },
  { id: 'biscuit',  name: 'Biscuit',    price: 3 },
  { id: 'cream',    name: 'Whipped',    price: 2 },
  { id: 'cinnamon', name: 'Cinnamon',   price: 2 },
];
...
function makeOrder(i, level = 5) {
  ...
  const moods = [
    ...
    `${temp === 'iced' ? 'Iced' : 'Hot'} ${tea.name}, if you don't mind.`,
...
Object.assign(window, { TEA_TYPES, CUPS, EXTRAS, CAT_NAMES, CAT_COLORS, makeOrder });
